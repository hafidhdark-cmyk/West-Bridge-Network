...
export default function HomePage() {
  ...
  // In specific category view (e.g., Politics), show ALL category articles in the feed!
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FAFAF9]">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
        ...
        {/* Loading Spinner Skeleton (Zero Split-Second Flash of Old Data) */}
        {isLoading ? (
          <div className="py-20 text-center space-y-4">
            <Loader2 className="w-10 h-10 text-wbn-blue animate-spin mx-auto" />
            <p className="text-xs font-bold text-wbn-navy uppercase tracking-widest">Fetching Latest Live News from West Bridge Network Bureau...</p>
          </div>
        ) : (
          <>
